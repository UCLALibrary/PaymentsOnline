  ...
  extends HttpServlet
{
  ...
  private void handlePayment( HttpServletRequest request, Logger log )
  {
    ...
    client.setInvoiceNumber( request.getParameter( "UCLA_REF_NO" ) );
    client.setPaymentTypeID( ( request.getParameter( "pmtcode" ).equalsIgnoreCase( "CC" ) ?
                               3: 2 ) );
    client.setResourceURI( getServletContext().getInitParameter( "uri.payment" ) );
