# PaymentsOnline
A web applicatio that allows users to select unpaid invoices from Xero or Alma and submit payments via the campus TRansact system.
...
The Maven build uses a custom repo hosted in GitHub, [v](https://github.com/UCLALibrary/MavenForDLSR). To access this repo, the Maven `settings.xml` file 
